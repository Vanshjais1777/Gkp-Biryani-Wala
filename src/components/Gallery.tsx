      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center gap-4">
            ...
            <a href='https://www.instagram.com/biryaniwala_188/?hl=en'
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-full hover:border-amber-500 hover:text-amber-600 transition-all duration-300"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryImages.map((image, index) => (
            <div
              key={image.id}
              className={`relative group cursor-pointer overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 ${index % 3 === 0 ? 'md:col-span-2 lg:col-span-1' : ''
